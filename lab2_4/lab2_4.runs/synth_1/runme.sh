...
HD_PWD='/home/student/lab2_4/lab2_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab2_4.tcl

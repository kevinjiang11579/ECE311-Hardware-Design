...
HD_PWD='/home/student/lab2_3/lab2_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab2_3.tcl -notrace

...
HD_PWD='/home/student/lab2_3/lab2_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab2_3.tcl

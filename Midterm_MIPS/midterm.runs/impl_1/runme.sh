...
HD_PWD='/home/student/midterm/midterm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log imptop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source imptop.tcl -notrace

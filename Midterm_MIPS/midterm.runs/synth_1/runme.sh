...
HD_PWD='/home/student/midterm/midterm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imptop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imptop.tcl
